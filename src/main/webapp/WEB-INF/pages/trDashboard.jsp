...
<%--        <h1 class="text-2xl font-bold" name="user">Welcome, ${user.firstName} ${user.lastName}</h1>--%>
...
<%--                    <p class="text-sm text-gray-600" name="studentCounts">Students Enrolled: ${studentCounts}</p>--%>
